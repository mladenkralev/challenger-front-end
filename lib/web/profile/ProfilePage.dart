...
class _ProfilePageState extends State<ProfilePage> {
          ...
          body: Column(children: <Widget>[
            Flexible(
              ...
              children: [
                ...
                Flexible(
                    child: buildCard(
                        "Assigned challenges", sumOfChallenges().toString())),
                Flexible(child: buildCard("Rank", "0")),
              ],
            )),
            Flexible(
                child: Row(
  ...
  int sumOfChallenges() {
    return widget.userManager.getDailyAssignChallenges()!.length +
        widget.userManager.getMonthlyAssignChallenges()!.length +
        widget.userManager.getWeeklyAssignChallenges()!.length;
  }
